// app/(admin)/admin/auth/error/400/page.tsx
"use client";
        ...
        <div className="min-h-screen bg-gradient-to-br from-slate-50 via-orange-50 to-slate-100 flex items-center justify-center p-4">
            ...
            >
                <div className="bg-white rounded-2xl shadow-xl p-8 border border-slate-200">
                    ...
                    <h1 className="text-6xl font-bold text-slate-900 mb-4">400</h1>
                    <h2 className="text-2xl font-semibold text-slate-800 mb-3">Bad Request</h2>
