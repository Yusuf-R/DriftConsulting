// app/(admin)/admin/auth/signup/page.tsx
"use client";
        ...
        try {
            ...
            if (!signupResponse.ok || !signupResult.success) {
                ...
                const errorMessages: Record<string, { title: string; duration: number }> = {
                    SIGNUP_RATE_LIMIT_EXCEEDED: { title: "Too Many Attempts", duration: 7000 },
                    USER_ALREADY_EXISTS: { title: "Account Exists", duration: 5000 },
                    VALIDATION_ERROR: { title: "Invalid Input", duration: 4000 },
                };

                const error = errorMessages[signupResult.code] || { title: "Signup Failed", duration: 4000 };
            ...
            if (sessionResult?.error || !sessionResult?.ok) {
                toast.error("Session Creation Failed", {
                    description: "Account created but couldn't log you in. Please login manually.",
                    duration: 5000,
                });
        ...
        <div className="min-h-screen flex">
            ...
            <div
                ...
                <div className="absolute inset-0">
                    ...
                    />
                    <div
                        className="absolute top-20 right-20 w-96 h-96 bg-amber-500 rounded-full blur-3xl opacity-20 animate-pulse"/>
                    <div
                        className="absolute bottom-20 left-20 w-96 h-96 bg-orange-500 rounded-full blur-3xl opacity-20 animate-pulse"
                    ...
                    >
                        ...
                        <div className="space-y-6 max-w-md">
                            ...
                            <h2 className="text-4xl font-bold leading-tight">
                                Start managing projects like a{" "}
                                <span
                            ...
                            <p className="text-lg text-gray-300 leading-relaxed">
                                Get exclusive access to our comprehensive construction management platform.
                                Track projects, manage clients, and drive results.
                            </p>
            ...
            <div
                className="flex-1 flex items-center justify-center px-4 sm:px-6 lg:px-8 bg-white dark:bg-slate-900 py-12">
                <motion.div
                ...
                >
                    ...
                    <div className="text-center mb-8">
                        ...
                        <p className="text-slate-600 dark:text-slate-400">
                            Join the Drift Consulting admin team
                        </p>
                    </div>
                    ...
                    <form onSubmit={handleSubmit(onSubmit)} className="space-y-5">
                                ...
                                <div className="mt-3 space-y-2">
                                    {passwordRequirements.map((req) => (
                                        <div key={req.label} className="flex items-center gap-2 text-xs">
                                            ...
                                            <span
                                                className={req.met ? 'text-green-600 dark:text-green-400' : 'text-slate-500 dark:text-slate-400'}>
                                                {req.label}
                                            </span>
                                        </div>
                                    ))}
                        ...
                        <div>
                            ...
                            {/* Password Match Indicator - ADD THIS BLOCK */}
                        ...
                        <button
                            ...
                            className="w-full bg-gradient-to-r from-amber-500 to-orange-500 hover:from-amber-600 hover:to-orange-600 text-white font-semibold py-3 px-6 rounded-lg shadow-lg hover:shadow-xl transition-all disabled:opacity-50 disabled:cursor-not-allowed flex items-center justify-center gap-2 group"
                        >
                            {isSubmitting ? (
                                <>
                    ...
                    >
                        ...
                        <span
                            className="text-sm font-medium text-slate-700 dark:text-slate-300 group-hover:text-slate-900 dark:group-hover:text-white transition-colors">
